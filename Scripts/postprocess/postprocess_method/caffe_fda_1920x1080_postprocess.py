...
def buildGraph(sgs_builder,model_config):
    ...
    concat_out_tensors = []
    sgs_builder.buildTensor([10,43485],"lms_concat")
    ...
    concat_transpose_out_shape =  [43485,10]
...
def get_postprocess():
    model_config = {"name":"caffe_fda_1920x1080",
          "input" : ['283','276','290'],
          "input_shape" : [[1,1,4,43485],[1,1,2,43485],[1,1,10,43485]],
          "shape" : [1,43485],
          "out_shapes" : [[1,MAX_DETECTIONS,4],[1,MAX_DETECTIONS],[1,MAX_DETECTIONS],[1],[1,MAX_DETECTIONS],[1,43485,10]],
          "input_hw": [1080., 1920.]}
