...
def get_image(img_path, resizeH=48, resizeW=196, resizeC=3, norm=True, meanB=104, meanG=117, meanR=123, std=58.82, rgb=False, nchw=False):
    ...
    if norm and (resizeC == 3):
        ...
        img_norm = (img_norm/255 - [mean_vedc[0],mean_vedc[1],mean_vedc[2]]) / stddev_vec
