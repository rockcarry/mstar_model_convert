...
def buildGraph(sgs_builder,model_config):
    ...
    concat_out_tensors = []
    sgs_builder.buildTensor([10,6400],"lms_concat")
    ...
    concat_transpose_out_shape =  [6400,10]
...
def get_postprocess():
    model_config = {"name":"caffe_fda_640x480",
          "input" : ['283','276','290'],
          "input_shape" : [[1,1,4,6400],[1,1,2,6400],[1,1,10,6400]],
          "shape" : [1,6400],
          "out_shapes" : [[1,MAX_DETECTIONS,4],[1,MAX_DETECTIONS],[1,MAX_DETECTIONS],[1],[1,MAX_DETECTIONS],[1,6400,10]],
          "input_hw": [480., 640.]}
