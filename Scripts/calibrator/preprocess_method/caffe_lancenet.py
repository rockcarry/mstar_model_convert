...
def get_image(img_path, resizeH=608, resizeW=608, resizeC=3, norm=True, meanB=0, meanG=0, meanR=0, std=255, rgb=False, nchw=False):
    ...
    img_norm = cv2.resize(img_float, (resizeW, resizeH))
