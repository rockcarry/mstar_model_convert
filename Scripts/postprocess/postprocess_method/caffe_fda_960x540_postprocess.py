...
def buildGraph(sgs_builder,model_config):
    ...
    transpose_out_shape =  [1,10,10885]
...
def get_postprocess():
    model_config = {"name":"caffe_fda_960x540",
          "input" : ['283','276','290'],
          "input_shape" : [[1,10885,1,4],[1,10885,1,2],[1,10885,1,10]],
          "shape" : [1,10885],
          "out_shapes" : [[1,100,4],[1,100],[1,100],[1],[1,100],[1,10885,10]],
          "input_hw": [540., 960.]}
