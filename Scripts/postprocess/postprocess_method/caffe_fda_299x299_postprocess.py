...
def buildGraph(sgs_builder,model_config):
    ...
    concat_out_tensors = []
    sgs_builder.buildTensor([10,1735],"lms_concat")
    ...
    concat_transpose_out_shape =  [1735,10]
...
def get_postprocess():
    model_config = {"name":"caffe_fda_299x299",
          "input" : ['283','276','290'],
          "input_shape" : [[1,1,4,1735],[1,1,2,1735],[1,1,10,1735]],
          "shape" : [1,1735],
          "out_shapes" : [[1,MAX_DETECTIONS,4],[1,MAX_DETECTIONS],[1,MAX_DETECTIONS],[1],[1,MAX_DETECTIONS],[1,1735,10]],
          "input_hw": [299., 299.]}
