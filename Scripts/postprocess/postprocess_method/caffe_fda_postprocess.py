...
def buildGraph(sgs_builder,model_config):
    ...
    concat_out_tensors = []
    sgs_builder.buildTensor([10,4695],"lms_concat")
    ...
    concat_transpose_out_shape =  [4695,10]
...
def get_postprocess():
    model_config = {"name":"caffe_fda",
          "input" : ['283','276','290'],
          "input_shape" : [[1,1,4,4695],[1,1,2,4695],[1,1,10,4695]],
          "shape" : [1,4695],
          "out_shapes" : [[1,MAX_DETECTIONS,4],[1,MAX_DETECTIONS],[1,MAX_DETECTIONS],[1],[1,MAX_DETECTIONS],[1,4695,10]],
          "input_hw": [360., 640.]}
