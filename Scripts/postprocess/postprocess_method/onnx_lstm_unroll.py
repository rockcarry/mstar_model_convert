...
def buildGraph(sgs_builder,model_config,subid,total):
    ...
    sgs_builder.buildTensor([1,1,input_shape[-2],h0_shape[-1] + input_shape[-1]],prefix + "concat_out")
    ...
    sgs_builder.buildTensor([1,1,input_shape[-2],conv_output_shape_0_dim],prefix + "conv2d_out")
    ...
    # creat split #
    #             #
    general_shape = [1,1,input_shape[-2],conv_output_shape_0_dim//4]
    ## axis tensor
    axis_data = [3]
    axis_shape = [1]
    axis_data_vector = []
