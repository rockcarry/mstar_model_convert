...
def buildGraph(sgs_builder,model_config):
    ...
    transpose_out_shape =  [1,10,10140]
...
def get_postprocess():
    model_config = {"name":"caffe_fda_800x600",
          "input" : ['283','276','290'],
          "input_shape" : [[1,10140,1,4],[1,10140,1,2],[1,10140,1,10]],
          "shape" : [1,10140],
          "out_shapes" : [[1,100,4],[1,100],[1,100],[1],[1,100],[1,10140,10]],
          "input_hw": [600., 800.]}
