...
def arg_parse():
    ...
    parser.add_argument('-sth', '--sensitivity_threshold', default=0.002, type=float,
                        help='Sensitivity threshold (valid if 0<st<1) for upgrading to 16 bit quantization.')
    ...
    parser.add_argument('--save_quant_info', default=False, action='store_true',
...
def main():
    ...
    calibrator_custom.SIM_calibrator.STH = args.sensitivity_threshold
    ...
    net.save_quant_info = args.save_quant_info
    printf(str(net))
    if ':' in image_path:
