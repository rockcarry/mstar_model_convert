...
def buildGraph(sgs_builder,model_config):
    ...
    transpose_out_shape =  [1,10,43485]
...
def get_postprocess():
    model_config = {"name":"caffe_fda_1920x1080",
          "input" : ['283','276','290'],
          "input_shape" : [[1,43485,1,4],[1,43485,1,2],[1,43485,1,10]],
          "shape" : [1,43485],
          "out_shapes" : [[1,100,4],[1,100],[1,100],[1],[1,100],[1,43485,10]],
          "input_hw": [1080., 1920.]}
