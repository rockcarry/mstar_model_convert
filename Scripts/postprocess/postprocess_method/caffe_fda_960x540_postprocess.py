...
def buildGraph(sgs_builder,model_config):
    ...
    concat_out_tensors = []
    sgs_builder.buildTensor([10,10885],"lms_concat")
    ...
    concat_transpose_out_shape =  [10885,10]
...
def get_postprocess():
    model_config = {"name":"caffe_fda_960x540",
          "input" : ['283','276','290'],
          "input_shape" : [[1,1,4,10885],[1,1,2,10885],[1,1,10,10885]],
          "shape" : [1,10885],
          "out_shapes" : [[1,MAX_DETECTIONS,4],[1,MAX_DETECTIONS],[1,MAX_DETECTIONS],[1],[1,MAX_DETECTIONS],[1,10885,10]],
          "input_hw": [540., 960.]}
