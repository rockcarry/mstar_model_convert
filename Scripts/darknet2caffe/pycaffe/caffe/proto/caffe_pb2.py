...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='upsample_param', full_name='caffe.LayerParameter.upsample_param', index=60,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mish_param', full_name='caffe.LayerParameter.mish_param', index=61,
