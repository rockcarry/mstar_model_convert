...
def buildGraph(model_config,subid,total):
    ...
    output_list = sgs_chalk.Split(conv2d_1,NumSplits=4, axis=3,name=[prefix + "split_1_output#Tu",
                                  prefix + "split_1_output#Tf",prefix + "split_1_output#To",prefix + "split_1_output#Tg"])
    ...
    logistic_Tf = sgs_chalk.Logistic(output_list[1],name=prefix + "split_1_output#Tf_output")
    # creat LOGISTIC for To #
    logistic_To = sgs_chalk.Logistic(output_list[2],name=prefix + "split_1_output#To_output")
    # creat Tanh for Tg     #
...
def get_postprocess():
    ...
    for i in six.moves.range(lstm_num):
        ...
        model_config = {"name":modle_name,
              ...
              "input_shape" : [input_shape,indicator_shape,h0_shape,c0_shape],
              "out_shapes" : [output_shape]}
        outfilename = buildGraph(model_config,lstm_num - 1 - i,lstm_num)
