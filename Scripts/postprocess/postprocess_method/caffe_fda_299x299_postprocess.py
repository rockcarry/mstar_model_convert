...
def get_postprocess():
    model_config = {"name":"caffe_fda_299x299",
          "input" : ['283','276','290'],
          "input_shape" : [[1,1735,1,4],[1,1735,1,2],[1,1735,1,10]],
          "shape" : [1,1735],
          "out_shapes" : [[1,100,4],[1,100],[1,100],[1],[1,100],[1,1735,10]],
          "input_hw": [299., 299.]}
