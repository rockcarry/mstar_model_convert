...
def get_postprocess():
    model_config = {"name":"caffe_fda",
          "input" : ['283','276','290'],
          "input_shape" : [[1,4695,1,4],[1,4695,1,2],[1,4695,1,10]],
          "shape" : [1,4695],
          "out_shapes" : [[1,100,4],[1,100],[1,100],[1],[1,100],[1,4695,10]],
          "input_hw": [360., 640.]}
