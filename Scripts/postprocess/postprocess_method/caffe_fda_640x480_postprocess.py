...
def get_postprocess():
    model_config = {"name":"caffe_fda_640x480",
          "input" : ['283','276','290'],
          "input_shape" : [[1,6400,1,4],[1,6400,1,2],[1,6400,1,10]],
          "shape" : [1,6400],
          "out_shapes" : [[1,100,4],[1,100],[1,100],[1],[1,100],[1,6400,10]],
          "input_hw": [480., 640.]}
